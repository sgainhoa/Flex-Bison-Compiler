...
%token <str> RPROGRAM RIS RBEGIN RENDPROGRAM RVAR RINTEGER RFLOAT RENDPROCEDURE RPROCEDURE RIN ROUT RIF RTHEN RELSE RENDIF RGET RPUT_LINE RWHILE RDO RENDWHILE RCONTINUE
...
stmts : stmt TSEMIC //Añadir la acción correspondiente
        {
        $$ = new sentenciastruct; $$->cont = $1->cont;
        }
      | stmts stmt TSEMIC //Añadir la acción correspondiente
        {
        $$ = new sentenciastruct;
...
stmt :  ident TASSIG expr { 
	...
	{ codigo.completarInstrucciones($3->trues,$5) ;
	  ...
	  vector<int> tmp1 ; tmp1.push_back($7) ;
          ...
          codigo.completarInstrucciones($6->cont, $2);
 	  //Falta inicializar el atributo de stmt
          $$ = new sentenciastruct;
